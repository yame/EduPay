<template>
  <VDataTableServer
    ...
    :headers="headers"
    :items="data || []"
    :items-length="totalData || undefined"
    class="text-no-wrap"
      ...
      <VCardText class="pt-5">
        <div class="d-flex flex-wrap justify-center justify-sm-space-between gap-y-2 mt-2">
          <VSelect
            ...
            :items="[5, 10, 50, 100]"
            style="max-inline-size: 8rem; min-inline-size: 5rem; font-size: 95px;"
            label="Rows par page :"
            variant="filled"
          />
...
// Emits
const emit = defineEmits(['edit-status', 'update:itemsPerPage', 'update:page']);
