  ...
  <div class="flex">
    <div class="w-full h-25 relative">
      <div ref="dropZoneRef" class="cursor-pointer" @click="() => open()">
        <div v-if="fileData.length === 0" class="d-flex flex-column justify-center align-center gap-y-2 pa-7 drop-zone rounded">
        ...
        <div v-else class="d-flex justify-center align-center  drop-zone flex-wrap">
